...
class ExamController extends Controller
{
    ...
    public function indexData(Datatables $datatables)
    {
        ...
        return $datatables->eloquent($query)
            ->addColumn('action', function ($exam) {
                return view('exams.actions', ['exam' => $exam]);
            })
    ...
    public function delete($id)
    {
        ...
        return view('exams.delete', ['exam' => $exam]);
    }
    ...
    public function getAssignmentForm()
    {
        ...
        return view('exams.assign', compact('divisions', 'departments', 'units', 'users', 'groups', 'teams', 'exams', 'email_body'));
    }
