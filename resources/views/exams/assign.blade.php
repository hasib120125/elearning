...
@section('page-title', 'Assign Exam')
@section('content')
{!! Form::open(['id' => 'model-form','route' => ['exams.assign'], 'method'=>'POST']) !!}
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row clearfix">
                        <div class="col-md-8">
                            <div class="form-group required {{ $errors->has('exam_id') ? 'has-error' : ''}}">
                                <div class="col-md-3">
                                    <label class="control-label">Exam</label>
                                </div>
                                <div class="col-md-9">
                                    {!! Form::select('exam_id', $exams, null, ['class' => 'form-control select2', 'placeholder' => 'Select Exam', 'data-allow-clear' => 'true', 'data-tags' => 'true'])!!}
                    ...
                    <div class="row clearfix">
                        <div class="col-md-8">
                            <div class="form-group">
                                <div class="col-md-3">
                                    <label class="control-label">Threshold Mark</label>
                                </div>
                                <div class="col-md-9">
