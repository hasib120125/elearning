...
@section('page-title', 'Create Live Class')
@section('content') {!! Form::open(['id'=>'model-form','route' => 'courses.liveclass-save','method'=>'POST', 'enctype' => 'multipart/form-data']) !!}
            ...
            <div class="row clearfix">
              <div class="col-sm-6">
                <div class="form-group required {{ $errors->has('name') ? 'has-error' : ''}}">
                  ...
                  <div class="col-md-8">
                    {!! Form::text('title', null, ['placeholder' => 'Liveclass Title','class' => 'form-control']) !!}
