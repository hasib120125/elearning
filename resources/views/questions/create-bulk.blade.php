...
@section('content')
{!! Form::open(array('route' => 'questions.store-bulk','method'=>'POST', 'files'=>true)) !!}
      ...
      <div class="box box-default">
        <div class="box-body">
          <div class="callout callout-info">
            ...
            <p>please <a href="{{ route('template-files.download', 'bulk-question-import-template.xlsx' )}}">Click here</a> to download the template</p>
          </div>
        </div>
        @if($errors->count())
        <div class="box box-default">
